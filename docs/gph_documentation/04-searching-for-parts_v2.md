...
## **URL:** `/help/parts-search` **Page title:** Searching for Parts | GPH Help **Meta description:** Learn how to search for parts in Government Procurement Hub, read part records, and use the eight data tabs that provide complete part intelligence. **H1:** Searching for parts
...
CAGE codes link to the awarded vendor's profile — useful for researching competitive history on the part. To view a contract document, see [Viewing solicitations and contracts](http:///help/solicitations-and-contracts).
...
Use this tab to surface live opportunities tied to a specific part. To view a solicitation PDF or amendment history, see [Viewing solicitations and contracts](http:///help/solicitations-and-contracts).
...
- [Setting Up Bid-Matching Profiles](http:///help/bid-matching-profiles) — Match incoming solicitations automatically  
- [Plans and Pricing](http:///help/plans-and-pricing) — Compare feature access by plan
