...
// GET /api/library/solicitations/[id]/pdf - Stream solicitation PDF
// Proxies to: GET /api/v1/library/solicitations/{id}/pdf
export async function GET(
  ...
  try {
    ...
    const url = `${AUTH_CONFIG.API_BASE_URL}/library/solicitations/${solicitationId}/pdf`;
    ...
    console.error('Solicitation PDF proxy error:', error);
    return NextResponse.json(
