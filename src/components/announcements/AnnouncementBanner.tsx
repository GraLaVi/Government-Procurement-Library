...
> = {
  info: {
    ...
    dismiss: "text-blue-600 hover:text-blue-900 hover:bg-blue-100 dark:text-blue-300 dark:hover:text-blue-200 dark:hover:bg-blue-500/20",
  },
  warning: {
    accent: "bg-amber-500",
    ...
    cta: "text-amber-800 hover:text-amber-900 dark:text-amber-300 dark:hover:text-amber-200",
    dismiss: "text-amber-700 hover:text-amber-900 hover:bg-amber-100 dark:text-amber-300 dark:hover:text-amber-200 dark:hover:bg-amber-500/20",
  },
  critical: {
    accent: "bg-red-600",
    ...
    cardBorder: "border-red-300 dark:border-red-500/40",
    cta: "text-red-800 hover:text-red-900 dark:text-red-300 dark:hover:text-red-200",
    dismiss: "text-red-700 hover:text-red-900 hover:bg-red-100 dark:text-red-300 dark:hover:text-red-200 dark:hover:bg-red-500/20",
  },
};
